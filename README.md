...
👉 **Text Translation**: Translates the recognized text into a selected target language using Google's Gemini model.
...
Replace the placeholder values with your actual Gemini API credentials. You can obtain these credentials by signing up on the [Google AI Studio](https://aistudio.google.com/).
